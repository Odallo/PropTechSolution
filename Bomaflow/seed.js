...
async function seed() {
    ...
    // Add tenants - all to same landlord
    ...
    await db.saveUser('254733333333', 'Sarah Mwangi', 'Sunrise Apartments', 'C3', '254712345678', 15000);
    ...
    console.log('   Landlord: 254712345678 (Sunrise Apartments)');
